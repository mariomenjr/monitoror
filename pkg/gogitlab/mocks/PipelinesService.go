...
// NewPipelinesService creates a new instance of PipelinesService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
